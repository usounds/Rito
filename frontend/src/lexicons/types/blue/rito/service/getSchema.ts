...
const _langsSchema = /*#__PURE__*/ v.object({
	"$type": /*#__PURE__*/ v.optional(/*#__PURE__*/ v.literal("blue.rito.service.getSchema#langs")),
...
const _mainSchema = /*#__PURE__*/ v.procedure(
	"blue.rito.service.getSchema",
	{
		...
		"input": {
			"type": "lex",
			"schema": /*#__PURE__*/ v.object({ "nsid": /*#__PURE__*/ v.string(), }),
		},
		"output": {
			"type": "lex",
